...
namespace RPG.Quests {
    public class QuestList : MonoBehaviour, ISaveable, IPredicateEvaluator
    {
        ...
        {
            // if returns null, we do not have that quest otherwise we do
